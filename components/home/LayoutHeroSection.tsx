      ...
      <div className="grid place-items-center lg:max-w-screen-xl gap-8 mx-auto py-20 md:py-32">
        <div className="text-center space-y-8">
          <Badge variant="outline" className="text-sm py-2">
            ...
            <span>Welcome to Marketiq &ndash; The Marketing Agent Portal</span>
          </Badge>
          <div className="max-w-screen-md mx-auto text-center text-4xl md:text-6xl font-bold">
            <h1>
              The unified platform for
              <span className="text-transparent px-2 bg-gradient-to-r from-[#008ff7] to-[#f40076] bg-clip-text">
                agencies
              </span>
              <span className="hidden md:inline">, consultants</span>
              and brands<br />
              managing <span className="px-2 bg-gradient-to-r from-[#f40076] to-[#008ff7] text-transparent bg-clip-text">clients, campaigns</span> and AI-driven workflows.
            </h1>
          </div>
          <p className="max-w-screen-sm mx-auto text-xl text-muted-foreground">
            Build marketing campaigns, collaborate with clients, and harness the power of AI agents—all from a single intuitive dashboard.
          </p>
          <div className="space-y-4 md:space-y-0 md:space-x-4">
            <Button asChild className="w-5/6 md:w-1/4 font-bold group/arrow">
              <Link href="#ai-agent-demo">
                Try AI Campaign Agent
        ...
        <div className="relative group mt-14">
          ...
          <Image
            ...
            alt="Marketiq dashboard preview - dark"
          />
